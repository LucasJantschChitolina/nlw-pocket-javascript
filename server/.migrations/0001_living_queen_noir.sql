...
ALTER TABLE "goals" ADD COLUMN "desired_weekly_frequenc y" integer NOT NULL;--> statement-breakpoint
DO $$ BEGIN
...
END $$;
--> statement-breakpoint
ALTER TABLE "goals" DROP COLUMN IF EXISTS "desired_weekly_frequency";